...
namespace Jun {
    ...
    HRESULT Jun::Mesh::Load(const std::wstring& path)
    {
        return E_NOTIMPL;
    }

    bool Jun::Mesh::CreateVertexBuffer(void* data, UINT Count)
    {
    ...
    bool Jun::Mesh::CreateIndexBuffer(void* data, UINT Count)
    {
        mIndexCount = Count;
