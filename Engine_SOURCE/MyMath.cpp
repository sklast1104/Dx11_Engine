...
namespace Jun::math
{
	...
	const Vector4 Jun::math::Vector4::Zero = { 0.f, 0.f, 0.f, 0.f };
...
//	RECT Viewport::ComputeDisplaJunrea(DXGI_SCALING scaling, UINT backBufferWidth, UINT backBufferHeight, int outputWidth, int outputHeight) noexcept
//	{
//		RECT rct = {};
//
//		switch (int(scaling))
