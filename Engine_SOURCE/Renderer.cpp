...
namespace renderer
{
	...
	void SetupState()
	{
		...
		Shader* shader = Jun::Resources::Find<Shader>(L"TriangleShader");
	...
	void LoadShader()
	{
		...
		Material* spriteMateiral = new Jun::graphics::Material();
